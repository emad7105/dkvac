...
fn main() {
    ...
    for &n in ATTR_COUNTS {
        ...
        for &d in DELEGATION_LEVELS {
            ...
            let obtained_del = instantiation1::obtain_del(&pp, &ipar, &chain).expect("obtain del");
            ...
            print_row(
                ...
                d,
                "issue_cred",
                size::inst1_issue_cred_output_size(&cred, &proof),
            );
            print_row(
                "inst1",
                n,
                d,
                "obtain_cred",
                size::inst1_credential_size(&obtained_cred),
            );
            ...
            print_row(
                ...
                d,
                "issue_del",
                size::inst1_issue_del_output_size(&encdel),
            );
            print_row(
                "inst1",
                n,
            ...
            print_row(
                ...
                d,
                "obtain_del",
                size::inst1_obtain_del_output_size(&obtained_del),
            );
        }
    }
    ...
    for &n in ATTR_COUNTS {
        ...
        for &d in DELEGATION_LEVELS {
            ...
            let obtained_del = instantiation2::obtain_del(&pp, &ipar, &chain).expect("obtain del");
            ...
            print_row(
                ...
                d,
                "issue_cred",
                size::inst2_issue_cred_output_size(&cred, &proof),
            );
            print_row(
                "inst2",
                n,
                d,
                "obtain_cred",
                size::inst2_credential_size(&obtained_cred),
            );
            ...
            print_row(
                ...
                d,
                "issue_del",
                size::inst2_issue_del_output_size(&encdel),
            );
            print_row(
                "inst2",
                n,
            ...
            print_row(
                ...
                d,
                "obtain_del",
                size::inst2_obtain_del_output_size(&obtained_del),
            );
        }
    }
}
